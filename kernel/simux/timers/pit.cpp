...
#define PIT_COMMAND_CHANNEL0 0x00 // Configure channel 0
#define PIT_COMMAND_CHANNEL1 0x40 // Configure channel 1
#define PIT_COMMAND_CHANNEL2 0x80 // Configure channel 2
...
#define PIT_BINARY_MODE       0x00 // Binary counter mode (limits the counter to 65535)
#define PIT_COUNTER_BCD_MODE  0x01 // BCD counter mode (limits the counter to 9999)
...
#define PIT_TIMER_FREQUENCY 1193182 // 1.193182 MHz

#define PIT_RELOAD_VALUE_MAX 65535 // 16-bit counter
#define PIT_BCD_MAX 9999 // 16-bit BCD counter
...
{
    configure_channel(PIT_COMMAND_CHANNEL0, PIT_ACCESS_MODE_BOTH, PIT_OPERATING_MODE_4);
    ...
    {
        kpanic("PIC setup failed: frequency too high");
    }
